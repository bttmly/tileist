...
$.fn.tileist = function(options) {
  ...
  */
	...
	;
  var Color, TwoDimensionalArray, cell, color, colorize, column, defaults, dist, distanceOf, distances, focus, gridSize, head, htmlStr, i, randomIntFromInterval, scaleValues, scaledDistances, settings, style, _i, _len, _results;
